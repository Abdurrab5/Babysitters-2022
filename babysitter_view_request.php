...
if (isset($_GET['pending']) && $_GET['pending'] != '') {
	...
	$resultrtSql = mysqli_query($link, $rtSql);
	   ...
	   redirect_to("babysitter_view_request.php");
}
	...
	<div class="container">
				...
				<table class="table " id="table">
					...
					<tbody>
						...
						$busSql = "Select * from hirebabysitter where babysitter_id='$babysitter_id'";
...
<?php
			if($status=='Pending'){
				?>
<td>
									<a href="babysitter_view_request.php?pending=<?php echo $id; ?>" class="btn btn-sm btn-success" role="button">Accept</a>
								</td>
			<?php	
			}elseif($status=='Accepted'){
?>
<td>
									<a href="babysitter_view_request.php?accepted=<?php echo $id; ?>" class="btn btn-sm btn-warning" role="button">Pending</a>
								</td>
...
<?php
				...
				?>				
						<td><a href="babysitter_view_request.php?rejected=<?php echo $id; ?>" class="btn btn-sm btn-Danger" role="button">Rejected</a>
							</td>		 
							</tr>
					</tbody>
				<?php
